...
class studentClass:
    def __init__(self,root):
        ...
        #====buttons====
        self.btn_add=Button(self.root,text='Save',font=('goudy old style',15,"bold"),bg='#2196f3',cursor='hand2',command=self.add)
        self.btn_add.place(x=150,y=400,width=110,height=40)
        self.btn_add=Button(self.root,text='Update',font=('goudy old style',15,"bold"),bg='#4caf50',cursor='hand2',command=self.update)
        self.btn_add.place(x=270,y=400,width=110,height=40)
        self.btn_add=Button(self.root,text='Delete',font=('goudy old style',15,"bold"),bg='#f44336',cursor='hand2',command=self.delete)
        self.btn_add.place(x=390,y=400,width=110,height=40)
        self.btn_add=Button(self.root,text='Clear',font=('goudy old style',15,"bold"),bg='#607d8b',cursor='hand2',command=self.clear)
        ...
        btn_search=Button(self.root,text='Search',font=('goudy old style',15,"bold"),bg='#03e9f4',cursor='hand2',command=self.search).place(x=1070,y=60,width=120,height=28)
        ...
        self.CourseTable = ttk.Treeview(self.C_Frame,column=("roll","name","email","gender","dob","contact","admission","course","state","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
